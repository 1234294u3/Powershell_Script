...
Write-Host "\nRemoving existing IP addresses..." -ForegroundColor Yellow
...
Write-Host "Removing existing Default Gateway..." -ForegroundColor Yellow
Get-NetRoute -InterfaceIndex $InterfaceIndex -AddressFamily IPv4 | Where-Object {
    $_.DestinationPrefix -eq '0.0.0.0/0' -and $_.InterfaceIndex -eq $InterfaceIndex
